  ...
  return (
    ...
    >
      <div>
        ...
        <span className="ml-2 text-[#4a4a6a] text-sm font-medium uppercase tracking-wider">
          {unit}
        </span>
      </div>
      <p className="text-[#8b8ba7] text-base leading-relaxed">{description}</p>
    </motion.div>
  )
}
    ...
    >
      <div ref={ref} className="max-w-3xl mx-auto text-center mb-20">
        ...
        <motion.h2
          ...
          className="font-display text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-[#f0efff] mb-6"
        >
          Every mind is{' '}
        ...
        <motion.p
          ...
          className="text-[#8b8ba7] text-lg md:text-xl leading-relaxed"
        >
      ...
      >
        <p className="font-display text-3xl md:text-4xl lg:text-5xl font-semibold text-[#f0efff] leading-snug">
          "Their laughter. Their wisdom.
          <br />
          <span className="text-[#4a4a6a]">Reduced to a fading memory."</span>
        </p>

        {/* Divider line */}
        <div className="mt-12 flex items-center justify-center gap-4">
          <div className="h-px w-16 bg-gradient-to-r from-transparent to-[rgba(124,58,237,0.4)]" />
          <span className="text-[#4a4a6a] text-sm tracking-widest uppercase">
